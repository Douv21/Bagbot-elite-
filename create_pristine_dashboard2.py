...
# HTML Template for public2/index.html
...
<div class="page" id="page-dashboard">
  ...
  <header class="dash-header">
    ...
    <button class="btn-sm-gold" onclick="changeGuild()"><i class="fa-solid fa-shuffle"></i> Changer de serveur</button>
      ...
      <main class="dash-main" id="dashMain">
        ...
        <div class="content-panel" id="panel-announcements">
          ...
          <div class="config-card">
            ...
            <div class="form-actions">
              <button type="button" class="btn btn-primary" onclick="toast('Annonce envoyée !')"><i class="fa-solid fa-paper-plane"></i> Publier l'Annonce</button>
            </div>
          </div>
        </div>
...
print("public2/index.html recreated cleanly with all 28 panels!")
