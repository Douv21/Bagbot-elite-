...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('doigter', 'Doigter quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'doigter');

    const randomGif = getValidActionGifUrl(guildId, 'doigter');
    if (randomGif) {
