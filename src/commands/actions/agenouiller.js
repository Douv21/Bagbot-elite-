...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('agenouiller', 'S\'agenouiller devant quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'agenouiller');

    const randomGif = getValidActionGifUrl(guildId, 'agenouiller');
    if (randomGif) {
