...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('orgasme', 'Donner un orgasme à quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'orgasme');

    const randomGif = getValidActionGifUrl(guildId, 'orgasme');
    if (randomGif) {
