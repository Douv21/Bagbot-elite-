...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('seduire', 'Séduire quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'seduire');

    const randomGif = getValidActionGifUrl(guildId, 'seduire');
    if (randomGif) {
