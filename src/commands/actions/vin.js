...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('vin', 'Partager un verre de vin avec quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'vin');

    const randomGif = getValidActionGifUrl(guildId, 'vin');
    if (randomGif) {
