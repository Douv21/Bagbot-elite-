...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('embrasser', 'Embrasser quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'embrasser');

    const randomGif = getValidActionGifUrl(guildId, 'embrasser');
    if (randomGif) {
