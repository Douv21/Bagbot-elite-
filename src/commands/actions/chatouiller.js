...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('chatouiller', 'Chatouiller quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'chatouiller');

    const randomGif = getValidActionGifUrl(guildId, 'chatouiller');
    if (randomGif) {
