...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('rose', 'Offrir une rose à quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'rose');

    const randomGif = getValidActionGifUrl(guildId, 'rose');
    if (randomGif) {
