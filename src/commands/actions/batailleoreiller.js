...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('batailleoreiller', 'Lancer une bataille d\'oreillers', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'batailleoreiller');

    const randomGif = getValidActionGifUrl(guildId, 'batailleoreiller');
    if (randomGif) {
