...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('tirercheveux', 'Tirer les cheveux de quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'tirercheveux');

    const randomGif = getValidActionGifUrl(guildId, 'tirercheveux');
    if (randomGif) {
