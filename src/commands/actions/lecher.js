...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('lecher', 'Lécher quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'lecher');

    const randomGif = getValidActionGifUrl(guildId, 'lecher');
    if (randomGif) {
