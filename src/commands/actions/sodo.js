...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('sodo', 'Faire une sodo à quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'sodo');

    const randomGif = getValidActionGifUrl(guildId, 'sodo');
    if (randomGif) {
