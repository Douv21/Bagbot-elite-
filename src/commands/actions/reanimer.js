...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('reanimer', 'Réanimer quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'reanimer');

    const randomGif = getValidActionGifUrl(guildId, 'reanimer');
    if (randomGif) {
