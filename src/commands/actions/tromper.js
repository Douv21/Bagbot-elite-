...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('tromper', 'Tromper quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'tromper');

    const randomGif = getValidActionGifUrl(guildId, 'tromper');
    if (randomGif) {
