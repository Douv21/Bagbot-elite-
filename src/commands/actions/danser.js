...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('danser', 'Danser avec quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'danser');

    const randomGif = getValidActionGifUrl(guildId, 'danser');
    if (randomGif) {
