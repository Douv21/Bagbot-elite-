...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('douche', 'Prendre une douche avec quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'douche');

    const randomGif = getValidActionGifUrl(guildId, 'douche');
    if (randomGif) {
