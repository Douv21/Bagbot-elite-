...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('attrape', 'Attraper quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'attrape');

    const randomGif = getValidActionGifUrl(guildId, 'attrape');
    if (randomGif) {
