...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const aiPhrase = await generateAiActionPhraseFast('flirter', 'Flirter avec quelqu\'un', interaction.member, targetMember);
      if (aiPhrase) {
    ...
    const gifUrl = getValidActionGifUrl(guildId, 'flirter');

    const randomGif = getValidActionGifUrl(guildId, 'flirter');
    if (randomGif) {
