  ...
  async execute(interaction) {
    ...
    if (!hasDiscordNativePerm) {
      return interaction.reply({ 
        content: "❌ Vous devez posséder une permission de modération Discord native (Exclure temporairement, Gérer les messages, Expulser ou Bannir) pour créer un drop d'XP.", 
        ephemeral: true 
      });
    }
